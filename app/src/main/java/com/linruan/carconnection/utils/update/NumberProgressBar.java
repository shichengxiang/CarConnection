...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = attributes.getColor(R.styleable.UpdateAppNumberProgressBar_numberprogress_text_color, default_text_color);
        mTextSize = attributes.getDimension(R.styleable.UpdateAppNumberProgressBar_numberprogress_text_size, default_text_size);
        ...
        int textVisible = attributes.getInt(R.styleable.UpdateAppNumberProgressBar_numberprogress_text_visibility, PROGRESS_TEXT_VISIBLE);
