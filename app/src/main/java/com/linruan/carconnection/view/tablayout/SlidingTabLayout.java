package com.linruan.carconnection.view.tablayout;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorStartColor = ta.getColor(R.styleable.SlidingTabLayout_tl_indicator_startcolor, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#4B6A87" : "#ffffff"));
        mIndicatorEndColor = ta.getColor(R.styleable.SlidingTabLayout_tl_indicator_endcolor, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#4B6A87" : "#ffffff"));
